...
class Order(TimeStampedModel, table=True):
    ...
    cancelled_amount: Decimal = Field(default=Decimal('0.00'), max_digits=10, decimal_places=2)
    admin_commission_amount: Decimal = Field(default=Decimal('0.00'), max_digits=10, decimal_places=2)
    ...
    fullfillment_id: Optional[int] = Field(default=None,foreign_key="users.id")  # Foreign key to users
...
class OrderProduct(TimeStampedModel, table=True):
    ...
    admin_commission: Decimal = Field(default=Decimal('0.00'), max_digits=10, decimal_places=2)
