...
class EmailDuplicate(SQLModel):
    ...
    copy_content: bool = Field(default=True, description="Whether to copy the content from original template")
    is_active: bool = Field(default=False, description="Set the duplicated template as active or inactive")